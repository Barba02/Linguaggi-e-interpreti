...
public class ImpLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LPAR", "RPAR", "LCURL", "RCURL", "LBRACK", "RBRACK", "ASSIGN", "SEMICOLON", 
			"IF", "THEN", "ELSE", "WHILE", "OUT", "SKIPP", "POW", "MUL", "DIV", "MOD", 
			"ADD", "SUB", "NOT", "LT", "LEQ", "GT", "GEQ", "EQ", "NEQ", "AND", "OR", 
			"NAT", "BOOL", "DOT", "TOSTR", "STRING", "STRCHR", "ESC", "ID", "WS"
		};
	}
